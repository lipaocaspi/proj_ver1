                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(5),
                        child:
                            Text("Buscar y formar parte de un viaje", style: TextStyle(fontSize:17)),
                      ),
                    ),
                    Expanded(
                      child: Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(5),
                        child:
                            Text("Editar perfil", style: TextStyle(fontSize:17)),
                      ),
                    ),
                    Expanded(
                      child: Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(5),
                        child:
                            Text("Cambiar contraseña", style: TextStyle(fontSize:17)),
                      ),
                    ),
                    Expanded(
                      child: Padding(
