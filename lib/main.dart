  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      BlocProvider<UserBloc>(
        create: (context) => UserBloc(repository: UsersRepositoryImpl())
          ..add(InitialUserEvent()),
      ),
      BlocProvider<RideBloc>(
        create: (context) =>
            RideBloc(repository: RideRepositoryImpl())..add(InitialRideEvent()),
      ),
    ],
    child: MaterialApp(
      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
            ...
            prefixIconColor:
                Color.fromARGB(255, 131, 131, 131).withOpacity(0.8),
            contentPadding:
